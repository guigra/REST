...
public class PersistenceConfig{
	...
	public BasicDataSource restDataSource(){
		...
		basicDataSource.setUsername(this.user != null ? this.user : "root");
		basicDataSource.setPassword(this.pass != null ? this.pass : "dbroot");
	...
	public AnnotationSessionFactoryBean alertsSessionFactory(){
		...
		alertsSessionFactory
				.setPackagesToScan(new String[] { "com.guigrasoft.remote" });
